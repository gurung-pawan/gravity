...
func _ready() -> void:
	var id1 = Sim.make_body(4000000, 100, Vector2(0, 0), Vector2(0, 0))
	var id3 = Sim.make_body(1500000, 100, Vector2(4000, 0), Vector2(0, 0))
	var id2 = Sim.make_body(30000000, 100, Vector2(-4000, 0), Vector2(1000, 0))
